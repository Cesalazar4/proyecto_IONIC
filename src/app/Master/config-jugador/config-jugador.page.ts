...
export class ConfigJugadorPage implements OnInit {
  ...
  cambiarCaracteristica(i:any) {
    let p = this.data.caracteristicas[i].p_base;
    this.data.caracteristicas[i].bonificador = this.puntos[p];
    this.data.caracteristicas[i].suma_lado = this.puntos[p];
    this.data.caracteristicas[i].suma_lado = this.data.caracteristicas[i].p_base+this.data.caracteristicas[i].bonificador+this.data.caracteristicas[i].b_competencia;

  }

  sumarTotalLados(i:any) {
    this.data.caracteristicas[i].suma_lado = this.data.caracteristicas[i].p_base+this.data.caracteristicas[i].bonificador+this.data.caracteristicas[i].b_competencia;
  }
